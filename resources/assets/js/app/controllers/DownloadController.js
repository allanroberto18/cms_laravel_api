module.exports = function ($scope, $log, $uibModal, ClientAPIService) {
    ...
    var list = function (page) {
        ...
        ClientAPIService.getList('download', page)
    ...
    $scope.deleteSelected = function () {
        ...
        modalInstance.result.then(function () {
            ...
            if (selecteds.length > 0) {
                ClientAPIService.getDelete('download/remover', selecteds)
                    .then(function (data, status) {
                        $scope.itemsSelectedAll = false;
    ...
    $scope.save = function (entity) {
        ...
        if (entity.id) {
            ClientAPIService.getPut('download/atualizar/' + entity.id, entity)
                .then(function (data, status) {
                    $scope.message = data.data;
        ...
        ClientAPIService.getPost('download/salvar', entity)
            .then(function (data, status) {
                entity.id = data.id;
