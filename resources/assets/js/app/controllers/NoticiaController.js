module.exports = function ($scope, $log, $uibModal, ClientAPIService, ImageService) {
    ...
    $scope.save = function (entity) {
        ...
        if (entity.id) {
            ClientAPIService.getPut('noticia/atualizar/' + entity.id, entity)
                .then(function (data, status) {
                    $scope.message = data.data;
        ...
        ClientAPIService.getPost('noticia/salvar', entity)
            .then(function (data, status) {
                entity.id = data.id;
    ...
    $scope.upload = function (imagem) {
        ...
        ImageService.post(fd, 'noticia/upload')
            .then(function (data) {
